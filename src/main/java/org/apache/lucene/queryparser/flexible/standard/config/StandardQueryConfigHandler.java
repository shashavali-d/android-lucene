...
public class StandardQueryConfigHandler extends QueryConfigHandler {
  ...
  final public static class ConfigurationKeys  {
     ...
     * 
     * @see StandardQueryParser#setMultiTermRewriteMethod(RewriteMethod)
     * @see StandardQueryParser#getMultiTermRewriteMethod()
     */
    final public static ConfigurationKey<RewriteMethod> MULTI_TERM_REWRITE_METHOD = ConfigurationKey.newInstance();
     ...
     */
    final public static ConfigurationKey<Map<CharSequence, Resolution>> FIELD_DATE_RESOLUTION_MAP = ConfigurationKey.newInstance();
     ...
     * 
     * @see StandardQueryParser#setDateResolution(Resolution)
     * @see StandardQueryParser#getDateResolution()
     */
    final public static ConfigurationKey<Resolution> DATE_RESOLUTION = ConfigurationKey.newInstance();
  ...
  public StandardQueryConfigHandler() {
    ...
    set(ConfigurationKeys.FIELD_DATE_RESOLUTION_MAP, new HashMap<CharSequence, Resolution>());
