...
public class SortedInputIterator implements InputIterator {
  ...
  private ByteSequencesReader sort() throws IOException {
    ...
    try (ByteSequencesWriter writer = new ByteSequencesWriter(tempInput)) {
      BytesRef spare;
    ...
    return new ByteSequencesReader(tempDir.openChecksumInput(tempSortedFileName, IOContext.READONCE), tempSortedFileName);
  }
